...
public class TextPostViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_text_post_view, container, false);
        ...
        returnButton.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.action_textPostViewFragment_to_navigation_home));
